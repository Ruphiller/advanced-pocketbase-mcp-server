...
class PocketBaseMCPAgent {
        ...
        try {
            ...
            if (this.configuration.adminEmail && this.configuration.adminPassword) {
                try {
                    ...
                    await this.pb.admins.authWithPassword(this.configuration.adminEmail, this.configuration.adminPassword);
    ...
    setupTools() {
        ...
        this.server.registerTool('smithery_discovery', {
        ...
        this.server.registerTool('list_collections', {
        ...
        this.server.registerTool('get_collection', {
        ...
        this.server.registerTool('create_collection', {
        ...
        this.server.registerTool('update_collection', {
        ...
        this.server.registerTool('delete_collection', {
        ...
        this.server.registerTool('list_records', {
            title: 'List Records',
        ...
        this.server.registerTool('get_record', {
            title: 'Get Record',
        ...
        this.server.registerTool('create_record', {
            title: 'Create Record',
        ...
        this.server.registerTool('update_record', {
            title: 'Update Record',
        ...
        this.server.registerTool('delete_record', {
            title: 'Delete Record',
        ...
        this.server.registerTool('query_records', {
            title: 'Query Records',
        ...
        this.server.registerTool('list_admins', {
            title: 'List Admins',
        ...
        this.server.registerTool('create_admin', {
            title: 'Create Admin',
        ...
        this.server.registerTool('authenticate_user', {
        ...
        this.server.registerTool('realtime_subscribe', {
            ...
            try {
                ...
                const unsubscribe = await this.pb.collection(collection).subscribe(recordId || '*', (e) => {
        ...
        this.server.registerTool('realtime_unsubscribe', {
        ...
        this.server.registerTool('set_custom_header', {
        ...
        this.server.registerTool('list_custom_headers', {
        ...
        // Utility tools
        this.server.registerTool('validate_record', {
        ...
        // Bulk operations
        this.server.registerTool('bulk_import', {
    ...
    setupStripeTools() {
        if (!this.stripeService)
            return;
        this.server.registerTool('create_customer', {
        ...
        this.server.registerTool('get_customer', {
        ...
        this.server.registerTool('create_payment_intent', {
    ...
    setupEmailTools() {
        if (!this.emailService)
            return;
        this.server.registerTool('send_email', {
            title: 'Send Email',
    ...
    setupResources() {
        ...
        this.server.registerResource('collection_schema', new ResourceTemplate('pocketbase://collections/{collection}/schema', { list: undefined }), {
        ...
        this.server.registerResource('database_stats', 'pocketbase://stats', {
        ...
        this.server.registerResource('agent_status', 'agent://status', {
            title: 'Agent Status',
     ...
     */
    setupPrompts() {
        this.server.registerPrompt('setup_collection', {
...
Would you like me to create this collection with a basic schema, or do you want to specify custom fields?`
        ...
        this.server.registerPrompt('troubleshoot_error', {
